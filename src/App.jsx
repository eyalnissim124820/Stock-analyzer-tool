...
function ContextMenu({ x, y, items, onClose }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener("touchstart", close); // touch devices may not synthesize mousedown
...
function AnalysisChart({ data, isMobile }) {
  ...
  const hint = (
    <span style={{ font: `400 11px ${FONT}`, color: C.t50 }}>Scroll or pinch to zoom · Shift-scroll or drag to pan · Tap for crosshair</span>
  );
